...
* [Quick tour video here](https://www.youtube.com/watch?v=ZudiGftVDiE)
...
* This map was made to be played with the [ExcessivePlus](https://www.excessiveplus.net/) mod.
...
* There is no light configuration in the map.
...
* .aas file compiled with bspc.exe to add bots.

File AllTextures.zip contains all the TGA textures used in DN3D game.
These textures has no transparency, except some used in that map. I used [Krita](https://krita.org/) to change the color black to transparent.
After saving the TGA on Krita, you must convert it using [XnConvert](https://www.xnview.com/en/xnconvert/), otherwise the image wll be upsidown.
